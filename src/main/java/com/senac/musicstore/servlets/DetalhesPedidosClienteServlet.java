 ...
 * @author magno
 */
@WebServlet(name = "DetalhesPedidosClienteServlet", urlPatterns = {"/detalhespedidoscli"})
public class DetalhesPedidosClienteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/detalhesPedidosCli.jsp");   
    }
