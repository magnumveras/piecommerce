 ...
 * @author magno
 */
@WebServlet(name = "ConsultaPedidosServlet", urlPatterns = {"/consultapedidos"})
public class ConsultaPedidosServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            listapedidos = sp.listarPedidosTotais();
        ...
        response.sendRedirect(request.getContextPath() + "/consultaPedidosop.jsp");   
    }
